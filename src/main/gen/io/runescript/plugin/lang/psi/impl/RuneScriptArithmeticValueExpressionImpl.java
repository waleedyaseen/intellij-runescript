...
public class RuneScriptArithmeticValueExpressionImpl extends RuneScriptExpressionImpl implements RuneScriptArithmeticValueExpression {

  public RuneScriptArithmeticValueExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull RuneScriptVisitor visitor) {
    visitor.visitArithmeticValueExpression(this);
  }

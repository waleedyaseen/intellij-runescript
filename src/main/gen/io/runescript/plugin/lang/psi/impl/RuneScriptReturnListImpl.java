...
public class RuneScriptReturnListImpl extends ASTWrapperPsiElement implements RuneScriptReturnList {

  public RuneScriptReturnListImpl(@NotNull ASTNode node) {
    super(node);
  }

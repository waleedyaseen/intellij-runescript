...
public class RuneScriptNullLiteralExpressionImpl extends RuneScriptExpressionImpl implements RuneScriptNullLiteralExpression {

  public RuneScriptNullLiteralExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

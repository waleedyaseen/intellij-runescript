...
object RsElementGenerator {
    ...
    fun createLocalVariableExpression(
        project: Project,
        name: String,
    ...
    fun createStringLiteralContent(
        project: Project,
        content: String,
    ): RsStringLiteralContent {
    ...
    fun createExpressionStatement(
        project: Project,
        text: String,
    ): RsExpressionStatement {
        val element = createDummyFile(project, "[proc,dummy]()()$text;")
    ...
    private fun createDummySymFile(
        project: Project,
        text: String,
    ): PsiFile {
        val factory = PsiFileFactory.getInstance(project) as PsiFileFactoryImpl
    ...
    fun createNewLine(project: Project): PsiElement = createDummyFile(project, "\n").firstChild
}

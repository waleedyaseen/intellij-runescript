...
inline fun <reified T : PsiElement> PsiElement.getChildrenOfType(): Array<T> =
    PsiTreeUtil.getChildrenOfType(this, T::class.java) ?: arrayOf()

inline fun <reified T : PsiElement> PsiElement.getChildOfType(): T? = PsiTreeUtil.getChildOfType(this, T::class.java)

inline fun <reified T : PsiElement> PsiElement.getStrictParentOfType(): T? = PsiTreeUtil.getParentOfType(this, T::class.java, true)

inline fun <reified T : PsiElement> PsiElement.findDescendantOfType(
    noinline predicate: (T) -> Boolean = {
        true
    },
): T? = findDescendantOfType({ true }, predicate)

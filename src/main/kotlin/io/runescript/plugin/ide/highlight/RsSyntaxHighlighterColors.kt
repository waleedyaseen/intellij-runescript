...
object RsSyntaxHighlighterColors {
    ...
    val BLOCK_COMMENT =
        createTextAttributesKey(RUNESCRIPT_BLOCK_COMMENT, DefaultLanguageHighlighterColors.BLOCK_COMMENT)
    val LINE_COMMENT = createTextAttributesKey(RUNESCRIPT_LINE_COMMENT, DefaultLanguageHighlighterColors.LINE_COMMENT)
    val OPERATION_SIGN =
        createTextAttributesKey(RUNESCRIPT_OPERATION_SIGN, DefaultLanguageHighlighterColors.OPERATION_SIGN)
    ...
    val DOC_COMMENT_TAG =
        createTextAttributesKey(RUNESCRIPT_DOC_COMMENT_TAG, DefaultLanguageHighlighterColors.DOC_COMMENT_TAG)
    val DOC_COMMENT_LINK =
        createTextAttributesKey(RUNESCRIPT_DOC_COMMENT_LINK, DefaultLanguageHighlighterColors.DOC_COMMENT_TAG_VALUE)

    // Parser based attributes
    val SCRIPT_DECLARATION =
        createTextAttributesKey(RUNESCRIPT_SCRIPT_DECLARATION, DefaultLanguageHighlighterColors.FUNCTION_DECLARATION)
    val CONSTANT = createTextAttributesKey(RUNESCRIPT_CONSTANT, DefaultLanguageHighlighterColors.CONSTANT)
    val LOCAL_VARIABLE =
        createTextAttributesKey(RUNESCRIPT_LOCAL_VARIABLE, DefaultLanguageHighlighterColors.INSTANCE_FIELD)
    val SCOPED_VARIABLE =
        createTextAttributesKey(RUNESCRIPT_SCOPED_VARIABLE, DefaultLanguageHighlighterColors.STATIC_FIELD)
    ...
    val CLIENTSCRIPT_CALL =
        createTextAttributesKey(RUNESCRIPT_CLIENTSCRIPT_CALL, DefaultLanguageHighlighterColors.INSTANCE_METHOD)
    val CONFIG_REFERENCE =
        createTextAttributesKey(RUNESCRIPT_CONFIG_REFERENCE, DefaultLanguageHighlighterColors.CLASS_REFERENCE)
}

...
object RuneScriptElementGenerator {

    fun createNameLiteral(project: Project, text: String): RuneScriptNameLiteral {
        val element = createDummyFile(project, "[$text,dummy]")
        return PsiTreeUtil.findChildOfType(element, RuneScriptNameLiteral::class.java) as RuneScriptNameLiteral
    }

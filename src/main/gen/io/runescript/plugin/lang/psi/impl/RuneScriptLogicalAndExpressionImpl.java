...
public class RuneScriptLogicalAndExpressionImpl extends RuneScriptExpressionImpl implements RuneScriptLogicalAndExpression {

  public RuneScriptLogicalAndExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

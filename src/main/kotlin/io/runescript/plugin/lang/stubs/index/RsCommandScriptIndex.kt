...
class RsCommandScriptIndex : StringStubIndexExtension<RsScript>() {
    ...
    companion object {
        val KEY = StubIndexKey.createIndexKey<String, RsScript>("io.runescript.plugin.lang.stubs.index.RsCommandScriptIndex")
    }
}

...
public class RuneScriptBooleanLiteralExpressionImpl extends RuneScriptExpressionImpl implements RuneScriptBooleanLiteralExpression {

  public RuneScriptBooleanLiteralExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

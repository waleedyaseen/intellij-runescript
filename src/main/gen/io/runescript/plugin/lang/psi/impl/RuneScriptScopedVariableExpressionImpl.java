...
public class RuneScriptScopedVariableExpressionImpl extends RuneScriptExpressionImpl implements RuneScriptScopedVariableExpression {

  public RuneScriptScopedVariableExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

...
enum class RsTriggerType(val literal: String, val subjectType: RsPrimitiveType? = null, val allowParameters: Boolean = false, val parameterTypes: Array<RsPrimitiveType>? = null, val allowReturns: Boolean = false) {
    ...
    WORLDMAPELEMENTMOUSEOVER("worldmapelementmouseover", subjectType = MAPELEMENT, allowParameters = true, arrayOf(INT, INT)),
    WORLDMAPELEMENTMOUSELEAVE("worldmapelementmouseleave", subjectType = MAPELEMENT, allowParameters = true, arrayOf(INT, INT)),
    WORLDMAPELEMENTMOUSEREPEAT("worldmapelementmouserepeat", subjectType = MAPELEMENT, allowParameters = true, arrayOf(INT, INT)),

...
import io.runescript.plugin.ide.inspections.fixes.RsChangeLocalVariableTypeQuickFix
...
import io.runescript.plugin.ide.inspections.fixes.RsRemoveExtraArgumentsQuickFix
...
class RuneScriptTypeCheckerInspection : LocalInspectionTool() {
    ...
    private fun Diagnostic.quickFixes(): Array<LocalQuickFix> {
        ...
        RsChangeLocalVariableTypeQuickFix.from(this)?.let { return arrayOf(it) }
        val trigger =
            when (message) {

...
public class RuneScriptStringInterpolationExpressionImpl extends RuneScriptExpressionImpl implements RuneScriptStringInterpolationExpression {

  public RuneScriptStringInterpolationExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

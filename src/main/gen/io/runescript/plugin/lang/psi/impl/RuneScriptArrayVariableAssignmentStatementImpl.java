...
public class RuneScriptArrayVariableAssignmentStatementImpl extends RuneScriptStatementImpl implements RuneScriptArrayVariableAssignmentStatement {

  public RuneScriptArrayVariableAssignmentStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull RuneScriptVisitor visitor) {
    visitor.visitArrayVariableAssignmentStatement(this);
  }

...
public class RuneScriptArithmeticAdditiveExpressionImpl extends RuneScriptExpressionImpl implements RuneScriptArithmeticAdditiveExpression {

  public RuneScriptArithmeticAdditiveExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

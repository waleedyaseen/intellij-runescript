...
public class RuneScriptCompareExpressionImpl extends RuneScriptExpressionImpl implements RuneScriptCompareExpression {

  public RuneScriptCompareExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

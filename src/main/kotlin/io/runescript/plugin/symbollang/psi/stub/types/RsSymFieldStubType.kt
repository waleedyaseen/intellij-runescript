...
object RsSymFieldStubType :
    ...
    ): RsSymFieldStub = RsSymFieldStub(parentStub, this, dataStream.readUTF())
    ...
    ): RsSymFieldStub = RsSymFieldStub(parentStub, this, psi.text)

    override fun createPsi(stub: RsSymFieldStub): RsSymField = RsSymFieldImpl(stub, this)

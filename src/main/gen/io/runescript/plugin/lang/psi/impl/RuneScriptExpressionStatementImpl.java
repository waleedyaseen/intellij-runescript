...
public class RuneScriptExpressionStatementImpl extends RuneScriptStatementImpl implements RuneScriptExpressionStatement {

  public RuneScriptExpressionStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

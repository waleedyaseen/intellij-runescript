...
public class RuneScriptConstantExpressionImpl extends RuneScriptExpressionImpl implements RuneScriptConstantExpression {

  public RuneScriptConstantExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

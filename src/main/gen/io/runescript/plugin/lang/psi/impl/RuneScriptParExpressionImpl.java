...
public class RuneScriptParExpressionImpl extends RuneScriptExpressionImpl implements RuneScriptParExpression {

  public RuneScriptParExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

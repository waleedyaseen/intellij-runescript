...
public class RuneScriptReturnStatementImpl extends RuneScriptStatementImpl implements RuneScriptReturnStatement {

  public RuneScriptReturnStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

...
public class RuneScriptArithmeticBitwiseAndExpressionImpl extends RuneScriptExpressionImpl implements RuneScriptArithmeticBitwiseAndExpression {

  public RuneScriptArithmeticBitwiseAndExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull RuneScriptVisitor visitor) {
    visitor.visitArithmeticBitwiseAndExpression(this);
  }

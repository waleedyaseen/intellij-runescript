...
class RsScriptNameIndex : StringStubIndexExtension<RsScript>() {
    override fun getVersion(): Int = RsFileStubType.stubVersion

    override fun getKey(): StubIndexKey<String, RsScript> = KEY

    companion object {
        val KEY = StubIndexKey.createIndexKey<String, RsScript>("io.runescript.plugin.lang.stubs.index.RsScriptNameIndex")
    }
}

...
public class RuneScriptStringLiteralExpressionImpl extends RuneScriptExpressionImpl implements RuneScriptStringLiteralExpression {

  public RuneScriptStringLiteralExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

...
public class RuneScriptLogicalOrExpressionImpl extends RuneScriptExpressionImpl implements RuneScriptLogicalOrExpression {

  public RuneScriptLogicalOrExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

...
public class RuneScriptIntegerLiteralExpressionImpl extends RuneScriptExpressionImpl implements RuneScriptIntegerLiteralExpression {

  public RuneScriptIntegerLiteralExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

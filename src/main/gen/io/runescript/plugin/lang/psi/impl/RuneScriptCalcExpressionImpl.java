...
public class RuneScriptCalcExpressionImpl extends RuneScriptExpressionImpl implements RuneScriptCalcExpression {

  public RuneScriptCalcExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

...
public abstract class RuneScriptStatementImpl extends ASTWrapperPsiElement implements RuneScriptStatement {

  public RuneScriptStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

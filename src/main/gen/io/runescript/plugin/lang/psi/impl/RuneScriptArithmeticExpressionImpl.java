...
public abstract class RuneScriptArithmeticExpressionImpl extends RuneScriptExpressionImpl implements RuneScriptArithmeticExpression {

  public RuneScriptArithmeticExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

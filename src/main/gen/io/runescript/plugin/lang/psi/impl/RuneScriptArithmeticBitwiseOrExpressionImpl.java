...
public class RuneScriptArithmeticBitwiseOrExpressionImpl extends RuneScriptExpressionImpl implements RuneScriptArithmeticBitwiseOrExpression {

  public RuneScriptArithmeticBitwiseOrExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

...
public class RuneScriptDynamicExpressionImpl extends RuneScriptExpressionImpl implements RuneScriptDynamicExpression {

  public RuneScriptDynamicExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
